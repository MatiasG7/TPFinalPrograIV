...
public class EmpresaSistemas {
	private ArrayList <Empleado> empleados;
	private ArrayList <Puesto> puestos;
	private ArrayList <Convocatoria> convocatorias;
	private ArrayList <String> especializaciones;
	
	public EmpresaSistemas() {
		empleados = new ArrayList<Empleado>();
		puestos = new ArrayList<Puesto>();
		convocatorias = new ArrayList<Convocatoria>();
		especializaciones = new ArrayList<String>();
	}
	
	public void agregarEmpleado() {
		Scanner input = new Scanner(System.in); //habilita acceso de datos por teclado
		...
		if (nuevoEmpleado != null) {
			...
			if( puesto == null ) {
				...
				nombrePuesto = input.next();
				
				System.out.print("\nIngrese area de puesto: ");
				areaPuesto = input.next();
			}			
			...
			System.out.print("\nSI | NO");
			String tieneguita = input.next();
			
			// un quilombito aca, si encontramos el puesto pero por ejemplo el puesto es jerarquico pero el flaco pone que el empleado NO es JERARQUICO,
			// osea comun, tenemos una contradiccion y hay que arreglarlo.
			// Lo que me acabo de dar cuenta despues de hacer todo esto es que podes mandar que si lo encuentra le sacamos la opcion de poner
			// que tipo de empleado es y que se joda el usuario. Si encuentra el puesto que pone y es jerarquico PUMBA automaticamente el
			// empleado es jerarquico y que la chupe.
			
			if(puesto != null) {
				if( Objects.deepEquals(tieneguita, "SI") || Objects.deepEquals(tieneguita, "si") || !Objects.deepEquals(puesto.getClass().getSimpleName(), "PuestoJerarquico") ) {
				...
				} else if(Objects.deepEquals(tieneguita, "NO") || Objects.deepEquals(tieneguita, "no") || !Objects.deepEquals(puesto.getClass().getSimpleName(), "PuestoComun")) {
			...
			if( Objects.deepEquals(tieneguita, "SI") || Objects.deepEquals(tieneguita, "si") ) {
				...
				nuevoEmpleado = new EJerarquico(dni, nombre, puesto, fechaIngresoEmpresa);
				...
				nuevoEmpleado = new EComun(dni, nombre, puesto, fechaIngresoEmpresa);
			}
			...
			do {			
				...
				String especializacion = input.next();
				
				System.out.print("\nIngrese años de experiencia: ");
				int añosEspe = input.nextInt();
